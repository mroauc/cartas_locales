...
<body>
  <section>
    <div class="row justify-content-center">
        <img src="{{asset('storage/logos/3.jpg')}}" width="290px" height="240px" alt="">
    </div>
  </section>

  @foreach ($categorias->sortBy('pos_carta') as $categoria)
    <section class="menu mt-3">
        <div class="container bg-blur rounded shadow pt-2 pb-2 mb-4" style="background-color: #f1f1f1f2; width: 60%;">
          <div class="row">
            <div class="col-md-12">
